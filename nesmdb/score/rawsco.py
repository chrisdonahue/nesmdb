...
def rawsco_to_ndf(rawsco):
  ...
  ndf = [
      ...
      ('apu', 'p1', 'cv', 1, 0),
      ('apu', 'p1', 'vo', 0, 0),
      ('apu', 'p1', 'ss', 7, 0), # This is necessary to prevent channel silence for low notes
      ('apu', 'p2', 'du', 0, 0),
      ('apu', 'p2', 'lh', 1, 0),
      ('apu', 'p2', 'cv', 1, 0),
      ('apu', 'p2', 'vo', 0, 0),
      ('apu', 'p2', 'ss', 7, 0), # This is necessary to prevent channel silence for low notes
      ('apu', 'tr', 'lh', 1, 0),
      ('apu', 'tr', 'lr', 127, 0),
      ('apu', 'no', 'lh', 1, 0),
      ('apu', 'no', 'cv', 1, 0),
  ...
  for i in xrange(max_i):
    ...
    ch_to_last_volume[ch] = volume
    if nl != last_no_nl:
      ndf.append(('apu', ch, 'nl', nl, 0))
      last_no_nl = nl
    if np > 0 and np != last_no_np:
      ndf.append(('apu', ch, 'np', 16 - np, 0))
      ndf.append(('apu', ch, 'll', 0, 0))
    last_no_np = np
